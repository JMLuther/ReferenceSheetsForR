...
_This does not work on my Windows system, obviously_
A workaround can be done using the `showtext` package  
```{r}
...
ggplot(df, aes(Distribution, Value)) +
  ...
  annotate(geom="text", x=3, y=9, label= "Times Roman Italic", family="Times", 
           fontface="italic", lineheight=.8, color="red") +
  annotate(geom="text", x=1, y=1.75, label="Courier\nAnnotation text", colour="red",
